...
class CombinedModel(nn.Module):
    def __init__(self, num_classes=2):
        ...
        # size of EfficientNet B3 is 1536 and ViT B_16 is 1000
        #self.classifier = nn.Linear(1536 +1000, num_classes)  # Adjusted for combined output
        self.classifier =nn.Linear(2536, num_classes)
...
if __name__ == '__main__':
    app.run(debug=False, host='0.0.0.0', port=4300)